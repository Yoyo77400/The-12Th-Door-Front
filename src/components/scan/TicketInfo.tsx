...
export default function TicketInfo({ ticket }: TicketInfoProps) {
  return (
    <div className="bg-[#0E0A0F] border border-[#443149]/40 rounded-lg p-4 mb-4">
      <h3 className="text-lg font-medium text-white/90 mb-3">Informations du ticket</h3>
      
      <div className="space-y-2">
        <div className="flex justify-between">
          <span className="text-white/60">Événement:</span>
        ...
        {ticket.seat && (
          <div className="flex justify-between">
            <span className="text-white/60">Siège:</span>
        ...
        {ticket.gate && (
          <div className="flex justify-between">
            <span className="text-white/60">Porte:</span>
        ...
        <div className="flex justify-between">
          <span className="text-white/60">ID Ticket:</span>
