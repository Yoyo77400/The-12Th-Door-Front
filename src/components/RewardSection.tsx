  ...
  if (hasAccess) {
    ...
    <div className="space-y-4">
        ...
        <Button
            ...
            className="mt-9 px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition animated"
        >
            Scan my ticket
        </Button>
        </div>
    ...
    content = (
      <div className="space-y-2">
        ...
        <button className="mt-2 px-4 py-2 bg-white text-black rounded hover:bg-gray-100 transition">
            <Link href="https://www.socios.com/" className="hover:underline text-1xl">
